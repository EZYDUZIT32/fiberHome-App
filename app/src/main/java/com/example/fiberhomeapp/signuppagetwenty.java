...
public class signuppagetwenty extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signuppagetwenty);
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if(!(dataSnapshot.child("Clients").child(phone).exists()))
                {
                    ...
                    clientsdataMap.put("date", saveCurrentDate);
                    clientsdataMap.put("time", saveCurrentTime);
                    ...
                    RootRef.child("Clients").child(phone).updateChildren(clientsdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    ...
                                    {
                                        Toast.makeText(signuppagetwenty.this, "Congratulations Your Information Has been Submitted Successfully", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                        Intent intent = new Intent(signuppagetwenty.this, Waitingpage.class);
                                        startActivity(intent);
                                    }
                                    else
                                    {
                                        loadingBar.dismiss();
                                        Toast.makeText(signuppagetwenty.this, "Network Error Please try Again...", Toast.LENGTH_SHORT).show();
                                    }
                ...
                {
                    Toast.makeText(signuppagetwenty.this, "This"+phone+"already exists", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                    Toast.makeText(signuppagetwenty.this, "Please try again using another phone number ", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
