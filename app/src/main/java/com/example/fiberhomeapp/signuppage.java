...
public class signuppage extends AppCompatActivity
{
    ...
    public EditText FIRSTNAMER,SECONDNAMER,PHONENUMBERER,EMAILER,LOCATIONER,MBPSER,RESIDENCER;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MBPSER = (EditText) findViewById(R.id.signup_mbps);
    ...
    private void validateAccount(String firstname, String secondname, String phone, String email, String location, String mbps, String residence)
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                    ...
                    RootRef.child("Clients").child(phone).updateChildren(clientsdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    ...
                                    {
                                        Toast.makeText(signuppage.this, "Congratulations Your Information Has been Submitted Successfully", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                ...
                {
                    Toast.makeText(signuppage.this, "This"+phone+"already exists", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                    Toast.makeText(signuppage.this, "Please try again using another phone number ", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
