...
public class signuppagethirty extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signuppagethirty);
    ...
    private void validateAccount(String firstname, String secondname, String phone, String email, String location, String mbps, String residence)
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                    ...
                    RootRef.child("Clients").child(phone).updateChildren(clientsdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    ...
                                    {
                                        Toast.makeText(signuppagethirty.this, "Congratulations Your Information Has been Submitted Successfully", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                        Intent intent = new Intent(signuppagethirty.this, Waitingpage.class);
                                        startActivity(intent);
                                    }
                                    else
                                    {
                                        loadingBar.dismiss();
                                        Toast.makeText(signuppagethirty.this, "Network Error Please try Again...", Toast.LENGTH_SHORT).show();
                                    }
                ...
                {
                    Toast.makeText(signuppagethirty.this, "This"+phone+"already exists", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                    Toast.makeText(signuppagethirty.this, "Please try again using another phone number ", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
